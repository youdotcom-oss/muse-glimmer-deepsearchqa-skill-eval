...
Full run history and per-configuration results. Extracted from the README when it was shortened (content preserved verbatim). The concluded limits live in [README.md](../README.md).
